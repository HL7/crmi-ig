...
* **experimentalBehavior**: Whether or not the repository should throw an error if the artifact being released is not Experimental and references Experimental components
* Instance level:
