...
<table>
  ...
  <tr><td>CareTeam</td><td>CRMIShareableCareTeam (Roadmap Item)</td><td>N/A (no requirements)</td><td>CRMIPublishableCareTeam (Roadmap Item)</td><td>N/A (no requirements>)</td></tr>
  ...
  <tr><td>Location</td><td>CRMIShareableLocation (Roadmap Item)</td><td>N/A (no requirements)</td><td>CRMIPublishableLocation (Roadmap Item)</td><td>N/A (no requirements>)</td></tr>
  ...
  <tr><td>PractitionerRole</td><td>CRMIShareablePractitionerRole (Roadmap Item)</td><td>N/A (no requirements)</td><td>CRMIPublishablePractitionerRole (Roadmap Item)</td><td>N/A (no requirements>)</td></tr>
